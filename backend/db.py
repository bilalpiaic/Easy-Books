...
MODULE_REGISTRY: dict[str, dict] = {
    ...
    "uk_mtd": {
        "label":       "UK MTD VAT",
        "description": "UK Making Tax Digital VAT — period VAT return boxes, HMRC sandbox submit, and obligation logs.",
        "category":    "Localization",
        "icon":        "Landmark",
        "deps":        ["base"],
        "always":      False,
    ...
    "my_invois": {
        ...
        "description": "LHDN MyInvois e-invoice sandbox submit, UUID tracking, and submission logs.",
        "category":    "Localization",
        "icon":        "FileCheck",
        "deps":        ["base"],
        "always":      False,
